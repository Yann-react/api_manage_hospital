<?php 
    ...
    try{
        $stmt = $conn->prepare("INSERT INTO dossier_patient (nompat,prenompat,datenaisspat,lieunaisspat,localisation,telephonepat,emailpat,professionpa,antecedents) VALUES (:nompat,:prenompat,:datenaisspat,:lieunaisspat,:localisation,:telephonepat,:emailpat,:professionpa,:antecedents)");
